...
namespace Lan_Tic_Tac_Toe
{
    ...
    {     
        ...
        {
            InitializeComponent();
            MessaageReceiver.DoWork += MessaageReceiver_DoWork;
        ...
        private void MessaageReceiver_DoWork(object sender, DoWorkEventArgs e)
        {
            if(CheckState())
                return;
            FreezeBoard();
            lbl_yourTurn.Text = "Opponent's Turn!";
            ReceiveMove();
            lbl_yourTurn.Text = "Your Turn";
            if (!CheckState())
                UnFreezeBoard();             
        }
        ...
        private bool CheckState()
        {
            ...
            if (button1.Text == button2.Text && button2.Text == button3.Text && button3.Text != "")
            {
                ...
                {
                    lbl_yourTurn.Text = "You Won!";
                    MessageBox.Show("You Won!");
                }
                else
                {
                    lbl_yourTurn.Text = "You Lose";
            ...
            else if (button2.Text == button5.Text && button5.Text == button8.Text && button3.Text != "")
            {
            ...
            else if (button3.Text == button5.Text && button5.Text == button9.Text && button9.Text != "")
            {
                if (button1.Text[0] == PlayerChar)
                {
                    lbl_yourTurn.Text = "You Won!";
